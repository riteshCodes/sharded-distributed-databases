...
if __name__ == '__main__':
    ...
    for i in range(0, 20):
        ...
        test_data.set_to(hash_key=random.randint(0, 20), userID=random.randint(0, 30), name="Something", country="Germany")
        # set multiple key stores
        test_data.st_multiple(hash_key_list=[random.randint(21, 51), random.randint(52, 82), random.randint(83, 113)],
